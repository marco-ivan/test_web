...
const checkUname        = document.querySelector('#checkUname').textContent;
const checkMN           = document.querySelector('#checkMN').textContent;
const checkEmail        = document.querySelector('#checkEmail').textContent;
...
function validateUniqueMobileNumber() {
    ...
    if (mobile_number_input !== checkMN) {
        ...
        if(mobile_number_taken !== null) {
            document.querySelector('#mobile_number_taken').remove();
        }
    }
}
...
function validateUniqueEmail() {
    ...
    if (email_input !== checkEmail) {
        ...
        if(emailTaken !== null) {
            document.querySelector('#emailTaken').remove();
        }
    }
}
...
function validateUniqueUsername() {
    ...
    if (username_input !== checkUname) {
        ...
        if(usernameTaken !== null) {
            document.querySelector('#usernameTaken').remove();
        }
    }
}
